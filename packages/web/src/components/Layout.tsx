...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/application-checks', label: 'Application Checks', icon: 'M14 3v4a1 1 0 0 0 1 1h4M14 3H6a1 1 0 0 0-1 1v16a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V8l-5-5ZM9 14.5l2 2 4-4', roles: ORG_VIEW, requiresFeature: 'reconciliation' },
