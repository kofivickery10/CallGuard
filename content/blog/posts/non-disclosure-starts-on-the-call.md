---
title: "Non-disclosure starts on the call: checking what the customer said against the application."
ogTitle: "Non-Disclosure Starts on the Call"
breadcrumb: "Non-disclosure starts on the call"
description: "The CIDRA duty is the customer's, but the question asked on the call shapes how it is judged. What protection firms can check on the call, and why."
...
sources:
  - "Consumer Insurance (Disclosure and Representations) Act 2012, section 2|https://www.legislation.gov.uk/ukpga/2012/6/section/2"
  - "Consumer Insurance (Disclosure and Representations) Act 2012, section 3|https://www.legislation.gov.uk/ukpga/2012/6/section/3"
  - "Consumer Insurance (Disclosure and Representations) Act 2012, section 4|https://www.legislation.gov.uk/ukpga/2012/6/section/4"
  - "Consumer Insurance (Disclosure and Representations) Act 2012, section 5|https://www.legislation.gov.uk/ukpga/2012/6/section/5"
  - "Consumer Insurance (Disclosure and Representations) Act 2012, Schedule 1|https://www.legislation.gov.uk/ukpga/2012/6/schedule/1"
  - "Consumer Insurance (Disclosure and Representations) Act 2012, Schedule 2|https://www.legislation.gov.uk/ukpga/2012/6/schedule/2"
  - "FCA Handbook, ICOBS 5.1 (ICOBS 5.1.4G, disclosure)|https://www.handbook.fca.org.uk/handbook/ICOBS/5/1.html"
  - "Financial Ombudsman Service: Misrepresentation and non-disclosure|https://www.financial-ombudsman.org.uk/consumers/complaints-can-help/insurance/misrepresentation-non-disclosure"
  - "ABI Code of Practice: Managing Claims Involving Misrepresentation (July 2023 edition)|https://www.abi.org.uk/globalassets/files/publications/public/protection/abi-code-of-practice---managing-claims-involving-misrepresentation-for-insurance-products-july-2023.pdf"
---
...
The first two checks are behaviours on a call and can be written into a scorecard like any other criterion, which is the ground covered by [call monitoring for FCA-regulated advice firms](/use-cases/financial-services).

## Where CallGuard fits

CallGuard AI scores calls, or all the calls in a sale together, against your firm's own scorecard. For the third check, [Reconciliation](/application-reconciliation) compares what the customer said on the calls in a sale with the answers submitted on the insurer's application. Finding each question on the call and comparing the answers are rule-based; a model reads the customer's answer from the passages found, and its reasoning is kept for a person to weigh. An application format it has not seen is parked for a person, not guessed. A mismatch is a flag for your team to review, with a passage from the call and the reasoning behind it where there is any, not a verdict on the adviser.
